...
public class SwerveDrivePoseEstimator {
  ...
  public void addVisionMeasurement(Pose2d visionRobotPoseMeters, double timestampSeconds) {
    ...
    var twist = sample.get().poseMeters.wpiLog(visionRobotPoseMeters);
  ...
  private class InterpolationRecord implements Interpolatable<InterpolationRecord> {
    ...
    public InterpolationRecord interpolate(InterpolationRecord endValue, double t) {
      if (t < 0) {
        ...
        twist = new Twist2d(twist.dx, twist.dy, gyro_lerp.minus(gyroAngle).getRadians());

        return new InterpolationRecord(poseMeters.wpiExp(twist), gyro_lerp, modulePositions);
      }
    }
