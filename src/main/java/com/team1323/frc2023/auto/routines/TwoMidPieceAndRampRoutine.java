...
public class TwoMidPieceAndRampRoutine extends AutoRoutine {
    ...
    public TwoMidPieceAndRampRoutine(Quadrant quadrant) {
    ...
    public Request getRoutine() {
        ...
        final SequentialRequest getOnBridgeAndBalance = new SequentialRequest(
            ...
            new WaitForPrereqRequest(() -> shoulder.getPosition() >= 90.0, 2.0),
            ...
            new WaitForRemainingTimeRequest(0.375, runtimeStopwatch),
