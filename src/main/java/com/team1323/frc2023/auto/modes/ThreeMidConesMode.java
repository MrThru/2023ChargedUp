...
public class ThreeMidConesMode extends AutoModeBase {
    ...
    protected void routine() throws AutoModeEndedException {
        ...
        runAction(new WaitToPassYCoordinateAction(45, quadrant));
        ...
        //Second Cone Score
        LimelightProcessor.getInstance().setPipeline(Pipeline.DETECTOR);
        runAction(new SetTrajectoryAction(trajectories.secondConeScoreToThirdConePickup, Rotation2d.fromDegrees(40), 0.75, quadrant));
